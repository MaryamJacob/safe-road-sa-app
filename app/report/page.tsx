                    ...
                    <div className="space-y-2">
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="turning-arrow">
                            Add Turning Arrow
                          </SelectItem>
                          <SelectItem value="stop-sign">
                            New Stop Sign
                          </SelectItem>
                          <SelectItem value="speed-bump">Speed Bump</SelectItem>
                          <SelectItem value="pedestrian-crossing">
                            Pedestrian Crossing
                          </SelectItem>
                          <SelectItem value="road-marking">
                            Road Marking
                          </SelectItem>
                          <SelectItem value="other">Other</SelectItem>
                        </SelectContent>
                  ...
                  <div className="space-y-4 md:space-y-0 md:grid md:grid-cols-2 md:gap-4">
                    <div className="space-y-2">
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          <SelectItem value="completely-off">
                            Completely Off
                          </SelectItem>
                          <SelectItem value="one-direction">
                            One Direction Not Working
                          </SelectItem>
                          <SelectItem value="stuck-red">
                            Stuck on Red
                          </SelectItem>
                          <SelectItem value="stuck-green">
                            Stuck on Green
                          </SelectItem>
                          <SelectItem value="flashing">
                            Flashing/Intermittent
                          </SelectItem>
                          <SelectItem value="timing-issue">
                            Timing Issues
                          </SelectItem>
                        </SelectContent>
                      </Select>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="single-lane">
                            Single Lane
                          </SelectItem>
                          <SelectItem value="turning-lane">
                            Turning Lane Only
                          </SelectItem>
                        </SelectContent>
                      </Select>
                ...
                >
                  <div className="space-y-2">
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="traffic-director">
                          Traffic Director
                        </SelectItem>
                        <SelectItem value="emergency-response">
                          Emergency Response
                        </SelectItem>
                        <SelectItem value="accident-management">
                          Accident Management
                        </SelectItem>
