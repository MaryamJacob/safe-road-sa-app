...
export default function MapPage() {
  ...
  }, [filters, searchQuery, reports]) // Add 'reports' to the dependency array
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* The main Dialog component controls the state */}
      <Dialog open={!!selectedReport} onOpenChange={() => setSelectedReport(null)}>
        
        {/* The DialogContent goes INSIDE the Dialog component */}
